...
describe("CodeExecutor - LTE Comparison Test", function () {
  it("should work with numbers", function () {
    assert.deepEqual(run("1 <= 1"), true);
    assert.deepEqual(run("1 <= 2"), true);
    assert.deepEqual(run("-10 <= 0"), true);
    assert.deepEqual(run("2 <= 1"), false);
    assert.deepEqual(run("0 <= -10"), false);
  ...
  it("should work with strings", function () {
    ...
    assert.deepEqual(run('"No"<= "Yes"'), true);
  ...
  it("should compare numbers to strings", function () {
    ...
    assert.deepEqual(run('1 <= "1"'), true);
    assert.deepEqual(run('-1 <= "1"'), true);
    assert.deepEqual(run('1000 <= "-100"'), true);
    assert.deepEqual(run('1000 <= "Anything in the world."'), true);
  });
  ...
  it("should compare numbers to array literals", function () {
    ...
    assert.deepEqual(run("0 <= {1, 1, 2}"), true);
    assert.deepEqual(run('0 <= {1, "Ignore me."}'), true);
  });
  ...
  it("should compare strings to booleans", function () {
    ...
    assert.deepEqual(run('"Anything" <= FALSE'), true);
  });
  ...
  it("should compare array literals to strings", function () {
    ...
    assert.deepEqual(run('{"A", "B"} <= "B"'), true);
