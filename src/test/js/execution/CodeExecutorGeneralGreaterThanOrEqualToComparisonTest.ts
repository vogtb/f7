...
describe("CodeExecutor - GTE Comparison Test", function () {
  it("should work with numbers", function () {
    assert.deepEqual(run("1 >= 1"), true);
    assert.deepEqual(run("1 >= 2"), false);
    assert.deepEqual(run("2 >= 1"), true);
    assert.deepEqual(run("-10 >= 0"), false);
    assert.deepEqual(run("0 >= -10"), true);
  ...
  it("should work with strings", function () {
    ...
    assert.deepEqual(run('"No">= "Yes"'), false);
  ...
  it("should work with arrays", function () {
    ...
    assert.deepEqual(run("{44, 2, 3} >= {1}"), true);
  ...
  it("should compare numbers to strings", function () {
    ...
    assert.deepEqual(run('-1 >= "1"'), false);
    assert.deepEqual(run('1000 >= "-100"'), false);
    assert.deepEqual(run('1000 >= "Anything in the world."'), false);
  });
  ...
  it("should compare numbers to array literals", function () {
    ...
    assert.deepEqual(run("0 >= {1, 1, 2}"), false);
    assert.deepEqual(run('0 >= {1, "Ignore me."}'), false);
  });
  ...
  it("should compare strings to booleans", function () {
    ...
    assert.deepEqual(run('"TRUE" >= TRUE'), false);
    assert.deepEqual(run('"" >= TRUE'), false);
  ...
  it("should compare array literals to strings", function () {
    ...
    assert.deepEqual(run('{"A", "B"} >= "B"'), false);
