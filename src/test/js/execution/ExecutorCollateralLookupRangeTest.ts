 ...
 */
describe("Executor.execute - General Collateral Index Range", function () {
  it("should work with column-wise lookup", function () {
    runner()
      .addCell("Alpha", "A1", "= 1")
      .addCell("Alpha", "A2", "= 2")
      .addCell("Alpha", "A3", "= 3")
  ...
  it("should work with row-wise lookup", function () {
    runner()
      .addCell("Alpha", "A1", "= 1")
      .addCell("Alpha", "B1", "= 2")
      .addCell("Alpha", "C1", "= 3")
  ...
  it("should work with column-wise lookup with row offset first", function () {
    runner()
      .addCell("Alpha", "A1", "= 1")
      .addCell("Alpha", "A2", "= 2")
      .addCell("Alpha", "A3", "= 3")
  ...
  it("should work with column-wise lookup with row offset last", function () {
    runner()
      .addCell("Alpha", "A1", "= 1")
      .addCell("Alpha", "A2", "= 2")
      .addCell("Alpha", "A3", "= 3")
  ...
  it("should work with row-wise lookup with column offset first", function () {
    runner()
      .addCell("Alpha", "A1", "= 1")
      .addCell("Alpha", "B1", "= 2")
      .addCell("Alpha", "C1", "= 3")
  ...
  it("should work with row-wise collateral lookup with column offset last", function () {
    runner()
      .addCell("Alpha", "A1", "= 1")
      .addCell("Alpha", "B1", "= 2")
      .addCell("Alpha", "C1", "= 3")
  ...
  it("should return error when it is multi-dimensional and we are outside the bounds", function () {
    runner()
      .addCell("Alpha", "A1", "= 1")
      .addCell("Alpha", "A2", "= 2")
      .addCell("Alpha", "B1", "= 3")
  ...
  it("should work when it is multi-dimensional and referencing a *different* grid", function () {
    runner()
      .addCell("Alpha", "A1", "= 1")
      .addCell("Alpha", "A2", "= 2")
      .addCell("Alpha", "A3", "= 3")
  ...
  it("should not perform collateral lookup when range is wrapped in array literal", function () {
    runner()
      .addCell("Alpha", "A1", "= 1")
      .addCell("Alpha", "A2", "= 2")
      .addCell("Alpha", "A3", "= 3")
      ...
      .addCell("Alpha", "B4", "= 4.1")
      .addCell("Beta", "A1", "= {Alpha!A1:B5}")
      .addCell("Beta", "M99", "Push out this grid.")
      .addExpectedValue("Beta", "A1", 1.0)
      .addExpectedValue("Beta", "A2", 2.0)
      .addExpectedValue("Beta", "A3", 3.0)
      .addExpectedValue("Beta", "A4", 4.0)
  ...
  it("should perform range operations with index", function () {
    runner()
      .addCell("Alpha", "A1", "= 10")
      .addCell("Alpha", "A2", "= 20")
      .addCell("Alpha", "A3", "= 30")
