...
describe("Executor.execute - Equality Comparison", function () {
  ...
  it("should work with number to string comarison", function () {
  ...
  it("should work with number to array literal comparison", function () {
  ...
  it("should work with string to boolean comparison", function () {
  ...
  it("should work with array literla to string comparison", function () {
    runner()
  ...
  it("should pass errors throguh", function () {
    runner()
