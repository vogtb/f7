...
public class GeneralMultiplicationTest extends TestExecution {
  @Test
  public void test_Numbers() {
    runner().addCell("Alpha", "A1", "= 10 * 4").addExpectedValue("Alpha", "A1", 40.0).run();
    runner().addCell("Alpha", "A1", "= 0 * 0").addExpectedValue("Alpha", "A1", 0.0).run();
    runner().addCell("Alpha", "A1", "= 10 * -10").addExpectedValue("Alpha", "A1", -100.0).run();
    runner().addCell("Alpha", "A1", "= -10 * -4").addExpectedValue("Alpha", "A1", 40.0).run();
    runner().addCell("Alpha", "A1", "= 1e10 * 1.1").addExpectedValue("Alpha", "A1", 1.1E10).run();
  }

  @Test
  public void test_Boolean() {
    runner().addCell("Alpha", "A1", "= 9 * TRUE").addExpectedValue("Alpha", "A1", 9.0).run();
    runner().addCell("Alpha", "A1", "= 9 * FALSE").addExpectedValue("Alpha", "A1", 0.0).run();
    runner().addCell("Alpha", "A1", "= 9 * -TRUE").addExpectedValue("Alpha", "A1", -9.0).run();
    runner().addCell("Alpha", "A1", "= 9 * -FALSE").addExpectedValue("Alpha", "A1", 0.0).run();
  }
  ...
  public void test_String() {
    runner().addCell("Alpha", "A1", "= 9 * \"10\"").addExpectedValue("Alpha", "A1", 90.0).run();
    runner().addCell("Alpha", "A1", "= 9 * \"1e10\"").addExpectedValue("Alpha", "A1", 9e10).run();
    runner().addCell("Alpha", "A1", "= 9 * \"0\"").addExpectedValue("Alpha", "A1", 0.0).run();
  }
  ...
  public void test_Array() {
    runner().addCell("Alpha", "A1", "= 3 * {2}").addExpectedValue("Alpha", "A1", 6.0).run();
    runner().addCell("Alpha", "A1", "= 3 * {2, 44}").addExpectedValue("Alpha", "A1", 6.0).run();
    runner().addCell("Alpha", "A1", "= 3 * -{2, \"Ignore me.\"}").addExpectedValue("Alpha", "A1", -6.0).run();
  }

  @Test
  public void test_Blank() {
    runner().addCell("Alpha", "A1", "= 2 * M44").addExpectedValue("Alpha", "A1", 0.0).run();
  }
