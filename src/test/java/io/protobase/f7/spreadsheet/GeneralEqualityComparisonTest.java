...
public class GeneralEqualityComparisonTest extends TestExecution {
  @Test
  ...
  public void test_ArrayLiteralToString() {
    ...
    runner().addCell("Alpha", "A1", "= \"B\" = {\"A\", \"B\"}").addExpectedValue("Alpha", "A1", false).run();
  }
  ...
  public void test_ArrayLiteralToBoolean() {
    ...
    runner().addCell("Alpha", "A1", "= TRUE = {FALSE, FALSE}").addExpectedValue("Alpha", "A1", false).run();
  }
