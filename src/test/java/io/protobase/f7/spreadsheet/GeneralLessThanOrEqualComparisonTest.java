...
public class GeneralLessThanOrEqualComparisonTest extends TestExecution {
  @Test
  ...
  public void test_ArrayLiteral() {
    ...
    runner().addCell("Alpha", "A1", "= {44, 2, 3} <= {1}").addExpectedValue("Alpha", "A1", false).run();
  ...
  public void test_NumberToString() {
    ...
    runner().addCell("Alpha", "A1", "= 1000 <= \"Anything in the world.\"").addExpectedValue("Alpha", "A1", true).run();
  }
  ...
  public void test_NumberToArrayLiteral() {
    ...
    runner().addCell("Alpha", "A1", "= 0 <= {1, \"Ignore me.\"}").addExpectedValue("Alpha", "A1", true).run();
  }
  ...
  public void test_StringToBoolean() {
    ...
    runner().addCell("Alpha", "A1", "= \"Anything\" <= FALSE").addExpectedValue("Alpha", "A1", true).run();
  }
  ...
  public void test_ArrayLiteralToString() {
    ...
    runner().addCell("Alpha", "A1", "= {\"A\", \"B\"} <= \"B\"").addExpectedValue("Alpha", "A1", true).run();
