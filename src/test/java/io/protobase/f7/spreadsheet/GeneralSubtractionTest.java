...
public class GeneralSubtractionTest extends TestExecution {
  @Test
  public void test_Numbers() {
    ...
    runner().addCell("Alpha", "A1", "= -10 - -4").addExpectedValue("Alpha", "A1", -6.0).run();
    runner().addCell("Alpha", "A1", "= 1e10 - 1.1").addExpectedValue("Alpha", "A1", 9.9999999989E9).run();
  }
  ...
  public void test_String() {
    ...
    runner().addCell("Alpha", "A1", "= 9 - \"1e10\"").addExpectedValue("Alpha", "A1", -9.999999991E9).run();
  ...
  public void test_Array() {
    ...
    runner().addCell("Alpha", "A1", "= 3 - -{1, \"Ignore me.\"}").addExpectedValue("Alpha", "A1", 4.0).run();
  }
