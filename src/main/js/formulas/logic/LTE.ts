...
export class LTE extends AbstractFormula {
  static SELF: LTE = new LTE();
  NAME = FormulaName.LTE;
  ...
  internal(origin: SheetColumnRowKey, ...values: Array<Complex>) {
    ...
    return comparison === ComparisonResult.LESS_THAN || comparison === ComparisonResult.EQUAL;
  }
}
