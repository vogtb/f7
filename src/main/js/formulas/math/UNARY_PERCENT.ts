...
export class UNARY_PERCENT extends AbstractFormula {
  static SELF: UNARY_PERCENT = new UNARY_PERCENT();
  NAME = FormulaName.UNARY_PERCENT;
  ...
  internal(origin: SheetColumnRowKey, ...values: Array<Complex>) {
    ...
    return Converters.toNumber(value) * 0.01;
  }
}
