...
public class EQ extends AbstractFormula {
  public static FormulaName NAME = FormulaName.EQ;
  public static EQ SELF = new EQ();

  public EQ() {
    super();
  }

  public EQ(Function<Object, Object> lookup, BiFunction<GridColumnRowKey, Object, Object> collateralLookup) {
  ...
  public Object internal(GridColumnRowKey origin, Object... values) {
    ...
    return result.equals(ComparisonResult.EQUAL);
  }
}
