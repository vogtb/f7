...
public class GTE extends AbstractFormula {
  public static FormulaName NAME = FormulaName.GTE;
  public static GTE SELF = new GTE();

  public GTE() {
    super();
  }

  public GTE(Function<Object, Object> lookup, BiFunction<GridColumnRowKey, Object, Object> collateralLookup) {
  ...
  public Object internal(GridColumnRowKey origin, Object... values) {
    ...
    return result.equals(ComparisonResult.GREATER_THAN) || result.equals(ComparisonResult.EQUAL);
  }
}
