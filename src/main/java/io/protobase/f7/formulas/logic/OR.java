...
public class OR extends AbstractFormula {
  public static FormulaName NAME = FormulaName.OR;
  public static OR SELF = new OR();

  public OR() {
    super();
  }

  public OR(Function<Object, Object> lookup, BiFunction<GridColumnRowKey, Object, Object> collateralLookup) {
