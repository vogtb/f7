...
public class LTE extends AbstractFormula {
  public static FormulaName NAME = FormulaName.LTE;
  public static LTE SELF = new LTE();

  public LTE() {
    super();
  }

  public LTE(Function<Object, Object> lookup, BiFunction<GridColumnRowKey, Object, Object> collateralLookup) {
  ...
  public Object internal(GridColumnRowKey origin, Object... values) {
    ...
    return result.equals(ComparisonResult.LESS_THAN) || result.equals(ComparisonResult.EQUAL);
  }
}
