...
public class EXACT extends AbstractFormula {
  public static FormulaName NAME = FormulaName.EXACT;
  public static EXACT SELF = new EXACT();

  public EXACT() {
    super();
  }

  public EXACT(Function<Object, Object> lookup, BiFunction<GridColumnRowKey, Object, Object> collateralLookup) {
  ...
  public Object internal(GridColumnRowKey origin, Object... values) {
    ...
    return Converters.toText(first).equals(Converters.toText(second));
  }
}
