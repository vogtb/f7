...
public class ABS extends AbstractFormula {
  public static FormulaName NAME = FormulaName.ADD;
  public static ABS SELF = new ABS();

  public ABS() {
    super();
  }

  public ABS(Function<Object, Object> lookup, BiFunction<GridColumnRowKey, Object, Object> collateralLookup) {
  ...
  public Object internal(GridColumnRowKey origin, Object... values) {
    ...
    return Math.abs(Converters.toDouble(value));
  }
}
